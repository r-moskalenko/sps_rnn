...
net_arg.add_argument('--shared_embed', type=int, default=200) # TODO: 200, 500, 1000
net_arg.add_argument('--shared_hid', type=int, default=200)
...
learn_arg.add_argument('--controller_max_step', type=int, default=200,
...
learn_arg.add_argument('--shared_decay_after', type=float, default=1)
