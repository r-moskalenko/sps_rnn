...
class Trainer(object):
    ...
    def build_model(self):
        ...
        self.controller = models.Controller(self.args,
                                            network_type=self.args.network_type,
                                            shared_rnn_activations=self.args.shared_rnn_activations,
                                            num_blocks=self.args.num_blocks,
                                            shared_cnn_types=self.args.shared_cnn_types,
    ...
    def train_shared(self, max_step=None, dag=None):
        ...
        hidden = self.shared.init_hidden(self.args.batch_size) # get hidden init tensor
        ...
        while train_idx < self.train_data.size(0):
            if step > max_step:
                break
    ...
    def train_controller(self):
        ...
        for step in range(self.args.controller_max_step):
            ...
            # policy loss
            loss = -log_probs.cpu()*torch.tensor(adv)
